    ...
    <div class="scroll-content col-sm-7 d-flex-start">
      ...
      <section class="resume w-1oovh" id="resume">
        <div class="section-head">
          ...
          <p>
            Click
            <a :href="linkedin" id="cv-link"  >here</a> to
            view my LinkedIn profile and resumé.
          </p>
          <!-- timeline -->
        </div>
      ...
      <section class="portfolio w-1oovh" id="portfolio">
        <div class="section-head">
          ...
          <span class="section-underline"></span>
          <p>Bet you wanna see some of the stuff I am boasting about?</p>
        </div>
        <div class="section-content">
          <!-- Restaurantly Modal  -->
...
export default {
  data() {
        return {
            linkedin: 'http://linkedin.com/in/xhantimpu'
        }
    },
  computed: {
    getprojects() {
